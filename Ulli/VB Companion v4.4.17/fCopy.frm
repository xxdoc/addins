   ...
   Begin MSComctlLib.Toolbar tb 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button10 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Key             =   "Cancel"
            Object.ToolTipText     =   "Discard and exit"
            ImageIndex      =   6
         EndProperty
      EndProperty
      BorderStyle     =   1
   End
   Begin VBCompanion.Fader FaderC 
      Left            =   5115
      Top             =   2655
      _ExtentX        =   979
      _ExtentY        =   450
...
Private Const Opax          As Long = 80 'opacity when no code is displayed so you can still see where code will go
Private Const CrsrTextPos   As Long = 32513
Private Const CrsrRightHand As Long = 32649
    ...
    If JustSearched Then
      ...
      Else 'JUSTSEARCHED = FALSE/0
        ...
        With rtfSource
            ...
            .Font.Name = sFontName
            If WithOpen Then
                'Copied from C:\Programme\Microsoft Visual Studio\VB98\Vb Sources\Formatter\fCopy.frm
                On Error Resume Next
                    With CDlg
                        Err.Clear
                        .InitDir = DirName
            ...
            .RightMargin = 0
            DoEvents
            If FileName <> vbNullString And Len(Dir$(FileName)) Then
                FileNum = FreeFile
    ...
    If KeyCode = vbKeyF3 Or KeyCode = vbKeyF Then
            ...
            With rtfSource
                If .SelLength Then
                  ...
                  Else '.SELLENGTH = FALSE/0
                    ...
                    CaretPos = 0
                    Select Case 0
                      Case InStr(vbLf & Forb, Mid$(Spce & .Text, .SelStart + 1, 1))
                        'char left of caret is not in Forb
                        CaretPos = -8
                      Case InStr(vbLf & Forb, Mid$(.Text & Spce, .SelStart + 1, 1))
        ...
        If Not SearchCancelled Then
            ...
            If SearchStart < 0 Then
                If MsgBoxEx("End of text reached." & vbCrLf & vbCrLf & "Would you like to resume at the beginning?", vbQuestion + vbYesNo, "Search [" & SearchString & "]", -1, -2) = vbYes Then
                    SendKeys "{F3}"
                End If
            End If
        End If
...
Private Sub SetPointerIcon(Icon As Long)
...
Private Sub tb_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    SetPointerIcon CrsrRightHand

End Sub

':) Ulli's VB Code Formatter V2.22.14 (2007-Feb-02 16:14)  Decl: 45  Code: 438  Total: 483 Lines
':) CommentOnly: 10 (2,1%)  Commented: 34 (7%)  Empty: 77 (15,9%)  Max Logic Depth: 8
